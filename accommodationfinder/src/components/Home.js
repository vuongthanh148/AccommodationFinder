...
class Home extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <Cover />
        <Search randomLoader={randomLoader} isLoggedIn={this.props.isLoggedIn} userData={this.props.userData} />
      </div>
    )
  }
}
  ...
  render() {
    return (
      <div className="slide-container">
        ...
        <Slide autoplay={true} duration={2000} pauseOnHover={false} transitionDuration={1000}>
          <div
...
class Search extends Component {
                ...
                axios.get(`https://thongtindoanhnghiep.co/api/city/${c.ID}/district`).then((res1) => {
                  res1.data.forEach((e) => {
                    if (
                      ...
                      res.data.localityInfo.administrative[2].name.replace(' District', '')
                    ) {
  ...
  getAccomod = async () => {
    ...
    await axios.post('https://accommodation-finder.herokuapp.com/accommodation', data_to_send).then((res) => {
  ...
  componentDidMount() {
    ...
    axios.get(`https://accommodation-finder.herokuapp.com/location`).then((res) => {
      // //"location: ", res.data);
      if (res)
        this.setState({
      ...
      <>
        <div className="search-section">
          <div className="search-container">
            ...
            >
              <form onSubmit={this.handleSubmit} className="search-grid-small search-grid">
                <div className="search-width">
                  <div className="search-margin">
                    <div className="search-width-1-1 search-inline">
                      <Select
                        components={{
                          Menu: (props) => <components.Menu {...props} className="menu"></components.Menu>,
                        }}
                        isClearable="true"
                  ...
                  <div className="search-margin">
                    <div className="search-width-1-1 search-inline">
                      <Select
                        ...
                        onChange={(publicPlace) => this.setState({ publicPlace })}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="search-margin ">
                    <ul className="search-other-features">
                      <li className={this.state.className}>
                        <a className="search-accordion-title" onClick={this.changeState}>
                          YÊU CẦU KHÁC
                        </a>
                          ...
                          <div className="search-grid-small search-grid other-feature">
                            <div className="search-other-margin">
                              ...
                              <label
                                ...
                                onClick={() => {
                                  this.setState({
                                    seperateAccommodation: !this.state.seperateAccommodation,
                                  })
                                }}
                              >
                                {this.state.seperateAccommodation ? 'Không chung chủ' : 'Chung chủ'}
                              </label>
                            </div>
                            ...
                            <div className="search-other-margin ">
                              ...
                              >
                                {this.state.airConditioner ? 'Điều hoà' : 'Không điều hoà'}
                              </label>
                            </div>
                            ...
                            <div className="search-other-margin ">
                              ...
                              >
                                {this.state.electricWaterHeater ? 'Nóng lạnh' : 'Không nóng lạnh'}
                              </label>
                            </div>
                            ...
                            <div className="search-other-margin ">
                              ...
                              >
                                {this.state.bathroom ? 'Vệ sinh riêng' : 'Vệ sinh chung'}
                              </label>
                            </div>
                            <div className="search-other-margin ">
                              <input
